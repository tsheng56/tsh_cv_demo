...
parser.add_argument('--cfg', '-c', type=str, default='configs/detect/coco_test_cfg.py', help='initial weights path')
...
opt.cfg_hyp = eval('cfg_hyp')
opt.cfg_hyp_custom = eval('cfg_hyp_custom')
