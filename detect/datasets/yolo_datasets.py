...
def load_mosaic(self, index):
    ...
    labels4, segments4 = [], []
    s = self.img_size
    yc = int(random.uniform(-self.mosaic_border[0], 2 * s[0] + self.mosaic_border[0]))   # mosaic center y
    xc = int(random.uniform(-self.mosaic_border[1], 2 * s[1] + self.mosaic_border[1]))   # mosaic center y
